                ...
                <div class="containerHome">
                    <div class="row" data-aos="fade-up" >
                            <div class="col-md-6">
                                ...
                                <Link to="/sanhcuoi" class="btn btn-main padding">Chi Tiết</Link>
                            </div>
                    ...
                    <div class="row padding">
                        <div class="col-md-6 order-md-1 order-2" data-aos="fade-up">
                            ...
                            <div class="col-md-6 order-md-12 order-1" data-aos="fade-up">
                                ...
                                <a href="#" class="btn btn-main padding">Chi Tiết</a>
                            </div>
                    </div>
                        <div class="row padding" data-aos="fade-up" >
                            <div class="col-md-6">
                                <div class="titBox"><a href="#" class="tit"><h2>DỊCH VỤ <b>TIỆC CƯỚI</b></h2></a></div>
